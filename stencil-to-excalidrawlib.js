...
class StencilToExcalidrawConverter {
	constructor() {
		...
		this.stencilMap = {
			...
			'bpmn': '../drawio-desktop/drawio/src/main/webapp/stencils/bpmn.xml',
			'networks': '../drawio-desktop/drawio/src/main/webapp/stencils/networks.xml',
			'networks2': '../drawio-desktop/drawio/src/main/webapp/stencils/networks2.xml',
			'kubernetes': '../drawio-desktop/drawio/src/main/webapp/stencils/kubernetes.xml',
			'kubernetes2': '../drawio-desktop/drawio/src/main/webapp/stencils/kubernetes2.xml',
			'aws3': '../drawio-desktop/drawio/src/main/webapp/stencils/aws3.xml',
			'aws3d': '../drawio-desktop/drawio/src/main/webapp/stencils/aws3d.xml',
			'aws4': '../drawio-desktop/drawio/src/main/webapp/stencils/aws4.xml',
			'azure': '../drawio-desktop/drawio/src/main/webapp/stencils/azure.xml',
			'gcp2': '../drawio-desktop/drawio/src/main/webapp/stencils/gcp2.xml',
			'eip': '../drawio-desktop/drawio/src/main/webapp/stencils/eip.xml',
